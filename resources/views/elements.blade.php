                                ...
                                <div class="panel-group" id="accordion">
                                    ...
                                    <div class="panel active">
                                        <div class="panel-heading">
                                            <h4 class="panel-title">Cras ex mauris, ornare eget pretium sit amet,
                                                dignissim et turpis</h4>
                                            <a data-toggle="collapse" data-parent="#accordion" href="#accordion1"></a>
                                        </div>
                                        <div id="accordion1" class="panel-collapse collapse">
                                            <div class="panel-body">
                                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eum sed
                                                    aut aliquid voluptatibus perferendis. Perferendis esse saepe natus
                                                    cupiditate, eligendi expedita nulla laudantium omnis nobis delectus
                                                    iusto quasi illo! Odit cupiditate.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Single Accordions -->
                                    <div class="panel">
                                        <div class="panel-heading">
                                            <h4 class="panel-title">Sed dapibus nunc vulputate mi fringilla, eu
                                                consequat</h4>
                                        ...
                                        <div id="accordion2" class="panel-collapse collapse">
                                            <div class="panel-body">
                                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eum sed
                                                    aut aliquid voluptatibus perferendis. Perferendis esse saepe natus
                                                    cupiditate, eligendi expedita nulla laudantium omnis nobis.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Single Accordions -->
